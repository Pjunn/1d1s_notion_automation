        ...
        habit = notion.pages.create(
            **{
                ...
                "properties": {
                    ...
                    "Date": {"date": diary["date"]["date"]},
                    "[Season 3] 유저 멤버 스페이스": {
                        "relation": [{"id": diary["memberId"]}]
                    },
                    "[Season 3] Streaks": {"relation": [{"id": streakId}]},
                    "완료": {"checkbox": True},
                },
            }
        )
...
def get_icon(diary):
    ...
    if diary["icon"]["type"] == "emoji":
        ...
        icon = {
            "type": diary["icon"]["type"],
            "external": {"url": diary["icon"]["external"]["url"]},
        }
...
def update_diary(diary):
    ...
    update = notion.pages.update(
        **{"page_id": diary["id"], "properties": {"운영진 확인용": {"checkbox": True}}}
    )
    return update
...
if __name__ == "__main__":
    diary = {
        "date": {
            "date": {"end": None, "start": "2024-02-16", "time_zone": None},
            "id": "ZC%5Cv",
            "type": "date",
        },
        ...
        "icon": {
            "file": {
                "expiry_time": "2024-02-17T07:58:07.259Z",
